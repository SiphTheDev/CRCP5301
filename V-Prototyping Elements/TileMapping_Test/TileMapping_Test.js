...
function setup() {
  ...
  //Next, just try making it a 2D array. If want to get fancy, load it from xml or something, but don't do that until basic functionality is there. - maybe just a rand fill + console log the vals?
