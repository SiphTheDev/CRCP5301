...
//In future: A main menu screen would start while it loads assets in preLoad, then a play option & a level select menu would be available. Level select only opens new levels once they've been reached. 
